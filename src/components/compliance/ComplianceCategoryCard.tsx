import { ComplianceCategoryExtended, ComplianceItem } from "@/types/compliance";
...
export function ComplianceCategoryCard({ category, items, onClick }: ComplianceCategoryCardProps) {
    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-[13px] font-semibold leading-tight">{category.displayName || category.name}</h3>
